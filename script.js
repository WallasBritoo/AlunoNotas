...
function addAluno(){
    ...
    let dadoNota1 = document.createElement('td');
    let inNotal = document.createElement('input');
    let dadoNota = '';
    let inNota= '';
    let dadoMedia = document.createElement("td");
    let outMedia = document.createElement("output");
    let dadoSituacao = document.createElement("dadoSituacao");
    let outSituacao = document.createElement("outSituacao");
